...
3. **Machine Learning (Zero-Copy):** Passaggio diretto del risultato aggregato da DuckDB a Pandas. Applicazione di una normalizzazione Z-score e addestramento di un modello **K-Means** per clusterizzare i quartieri in 3 livelli strategici (Alto, Medio, Basso traffico/valore).
